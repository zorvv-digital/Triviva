...
import { X, Calendar as CalendarIcon, MapPin, Send } from "lucide-react";
...
const RentalBookingModal = ({ vehicle, isOpen, onClose }: RentalBookingModalProps) => {
          ...
          >
            ...
            <div className="p-8 border-b border-black/[0.03] flex items-center justify-between bg-white relative">
              ...
              <div className="relative z-10">
                <span className="section-label mb-1.5 block">Fleet Rental</span>
