  ...
  return (
    <footer className="bg-[#fcfaf8] pt-24 overflow-hidden rounded-t-[3rem] mt-12 border-t border-black/[0.05]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-4">
            <h3 className="text-2xl font-display font-medium text-[#111827] leading-tight pr-4">
              Voyago is an independent premium travel agency and curator.
            </h3>
          </div>
          ...
          <div className="md:col-span-5 grid grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex flex-col gap-3">
                {[{ l: "Packages", p: "/packages" }, { l: "Gallery", p: "/gallery" }, { l: "About", p: "/about" }, { l: "Contact", p: "/contact" }].map(link => (
                  <Link 
                    key={link.p} 
                    to={link.p} 
            ...
            <div className="text-right sm:text-left">
              ...
              <div className="flex flex-col gap-3 items-end sm:items-start">
                <a href="#" className="flex items-center gap-2 px-3 py-1.5 bg-white border border-gray-200 rounded-full text-xs sm:text-sm font-body text-[#111827] hover:border-[#ea580c] transition-colors group">
            ...
            <div className="space-y-4">
              <Link to="/contact" className="group block">
                <div className="flex items-center justify-between border-b border-gray-200 pb-2 mb-2">
                  <h4 className="font-display text-lg text-[#ea580c] font-medium group-hover:opacity-80 transition-opacity">Call Voyago</h4>
      ...
      <div className="w-full overflow-hidden flex justify-center translate-y-6 md:translate-y-12">
        <h1 className="text-[25vw] leading-[0.75] font-display font-black text-[#111827] tracking-tighter">
          voyago
        </h1>
      </div>
    </footer>
