        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 xl:gap-16">
            ...
            >
              ...
              >
                <div className="z-10 w-full md:w-[58%] flex gap-5 items-start pr-4">
                  <div className="w-14 h-14 rounded-2xl bg-primary/5 flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div className="flex flex-col items-start gap-4">
                    ...
                    <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-primary/5 text-primary border border-primary/10 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                      Open Map
              ...
              >
                ...
                <div className="ml-auto flex-shrink-0">
                  <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold bg-emerald-500/10 text-emerald-700 border border-emerald-500/20 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-300">
                    Chat Now
                    <ArrowUpRight className="w-3.5 h-3.5" />
                  </span>
                </div>
            ...
            >
              ...
              <div className="relative z-10 mb-6 text-left">
                <span className="section-label mb-1 block">
                  {modalType === "whatsapp" ? "WhatsApp Chat" : "Direct Call"}
                </span>
                ...
                {data.contact.phone.lines.map((phone, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-xs font-semibold px-3 py-1.5 rounded-xl border transition-all duration-300 flex items-center gap-1 ${
                        modalType === "whatsapp"
                          ? "bg-emerald-500/5 text-emerald-700 border-emerald-500/10 group-hover:bg-emerald-600 group-hover:text-white group-hover:border-transparent"
                          : "bg-primary/5 text-primary border-primary/10 group-hover:bg-primary group-hover:text-white group-hover:border-transparent"
                      }`}>
                        {modalType === "whatsapp" ? "Chat" : "Call"}
